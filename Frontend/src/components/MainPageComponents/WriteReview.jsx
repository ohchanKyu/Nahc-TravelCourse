...
import { addReview } from "../../api/ReviewApiService";
...
const WriteReview = (props) => {
    ...
    const submitReviewHandler = async () => {
        ...
        const addReviewResponseData = await functionHandler(addReview,{
            data : formData
        })
        if (addReviewResponseData){
            Swal.fire({
                icon: 'success',                        
                title: '리뷰 등록 완료',         
                html: '리뷰를 등록하였습니다. <br> 확인해보세요!'
            });
            props.onFetchReview();
            props.onClose();
        }
        ...
        <div className={classes.container}>
            ...
            <div className={classes.button_container}>
                ...
                <motion.button 
                    ...
                    onClick={submitReviewHandler}>완료
                </motion.button>
            </div>
        </div>
